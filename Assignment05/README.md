### Flexible Notification System - WhatsApp Extension###
...
Project05:
- Extends the system by adding WhatsApp notification.
...
One of the new notification parameters now included is for WhatsApp.
...
Medium contains the classes for each medium (Email, SMS Messages, and WhatsApp) used for notifications implementing the NotificationMedium interface. 
Each class defines its own behavior for delivering a notification. WhatsApp class with its own method is now included. 
...
Nothing was changed in this for the inclusion of WhatsApp
